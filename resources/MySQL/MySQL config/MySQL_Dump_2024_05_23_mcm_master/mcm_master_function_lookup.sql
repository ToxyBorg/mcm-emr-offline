...
LOCK TABLES `function_lookup` WRITE;
/*!40000 ALTER TABLE `function_lookup` DISABLE KEYS */;
/*!40000 ALTER TABLE `function_lookup` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-23  6:55:08
