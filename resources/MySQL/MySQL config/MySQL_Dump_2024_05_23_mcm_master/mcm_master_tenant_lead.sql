...
--
-- Table structure for table `tenant_lead`
--

DROP TABLE IF EXISTS `tenant_lead`;
...
--
-- Dumping data for table `tenant_lead`
--

LOCK TABLES `tenant_lead` WRITE;
/*!40000 ALTER TABLE `tenant_lead` DISABLE KEYS */;
/*!40000 ALTER TABLE `tenant_lead` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-23  6:58:24
