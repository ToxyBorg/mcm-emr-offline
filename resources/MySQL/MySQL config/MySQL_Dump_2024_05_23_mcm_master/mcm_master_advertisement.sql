...
CREATE TABLE `advertisement` (
  ...
  `show_for_all_tenants` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`id`),
  KEY `FK_advertisement_lab` (`lab_id`),
  CONSTRAINT `FK_advertisement_lab` FOREIGN KEY (`lab_id`) REFERENCES `lab` (`id`)
...
-- Dump completed on 2024-05-23  6:56:05
