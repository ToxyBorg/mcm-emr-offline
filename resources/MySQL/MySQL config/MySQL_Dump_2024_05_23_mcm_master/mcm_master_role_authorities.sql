...
CREATE TABLE `role_authorities` (
  ...
  KEY `FK_role_authorities_authority` (`authority_id`),
  CONSTRAINT `FK_role_authorities_authority` FOREIGN KEY (`authority_id`) REFERENCES `authority` (`id`),
  CONSTRAINT `FK_role_authorities_role` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
...
-- Dump completed on 2024-05-23  6:56:10
