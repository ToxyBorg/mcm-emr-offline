...
CREATE TABLE `shortcuts` (
  ...
  `shortcuts_key` varchar(255) NOT NULL,
  `shortcuts_key_label` varchar(255) NOT NULL,
  `label` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
  `enabled` bit(1) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ct_shortcuts_key_unique` (`shortcuts_key`)
...
-- Dump completed on 2024-05-23  6:55:38
