...
CREATE TABLE `user_authorities` (
  ...
  KEY `FK_user_authorities_authority` (`authority_id`),
  CONSTRAINT `FK_user_authorities_authority` FOREIGN KEY (`authority_id`) REFERENCES `authority` (`id`),
  CONSTRAINT `FK_user_authorities_user` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`id`)
...
-- Dump completed on 2024-05-23  6:55:54
